...
2. Click "Open Model" to open a file picker and select a .stl, .glb, or .gltf file.

3. Alternatively, click "Sample Models" to load one of the pre-packaged models.

4. If an .stl file is selected, a conversion process will start automatically. A status indicator will show the progress.

5. Once loaded, interact with the model using your mouse or touchscreen:

6. Rotate: Left-click and drag / One-finger drag

7. Zoom: Mouse wheel / Two-finger pinch

8. Pan: Right-click and drag / Two-finger drag
